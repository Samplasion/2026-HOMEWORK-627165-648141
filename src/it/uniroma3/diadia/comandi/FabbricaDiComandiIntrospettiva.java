...
public class FabbricaDiComandiIntrospettiva implements FabbricaDiComandi {
	static private FabbricaDiComandiIntrospettiva instance;
	private Map<String, Class> comandi;
	
	private FabbricaDiComandiIntrospettiva() {
	...
	public static FabbricaDiComandiIntrospettiva instance() {
		if (instance == null) instance = new FabbricaDiComandiIntrospettiva();
		return instance;
	}
